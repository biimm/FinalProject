    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_show:
                ...
                break;
            case R.id.nav_use:
                Intent intent3 = new Intent(function_status.this , UseStatus.class);
                startActivity(intent3);
                break;
            case R.id.nav_basket:
                Intent intent4 = new Intent(function_status.this, LundryStatus.class);
                startActivity(intent4);
                break;
            case R.id.nav_wash:
                Intent intent5 = new Intent(function_status.this , WashStatus.class);
                startActivity(intent5);
            case R.id.nav_search:
                Intent intent6 = new Intent(function_status.this , SearchClothesfromcam.class);
                startActivity(intent6);
            case R.id.nav_match:
                Intent intent7 = new Intent(function_status.this , MatchCloth.class);
