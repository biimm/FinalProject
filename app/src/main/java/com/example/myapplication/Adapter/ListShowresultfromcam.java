...
public class ListShowresultfromcam extends BaseAdapter {
    ImageView mimage;
    Context mContext;
...
//    public int position_choose = 0;
    ...
    public ListShowresultfromcam(){
        //Empty Contructor
    }


    public ListShowresultfromcam(Context applicationContext,ArrayList<String> id
            ,ArrayList<String> pic_cloth
            ,ArrayList<String> type_cloth
            ,ArrayList<String> status_cloth
            ,ArrayList<String> color1
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if(convertView == null){
            ...
            convertView = mInflater.inflate(R.layout.listresultfromcam_adapter,parent,false);
        }
